/*
 * Hero preset — the dials tree the app edits and persists. Owned
 * entirely by the site; scope and crt know nothing about it.
 */
...
export function makeDefaultPreset(): HeroPreset {
  return {
