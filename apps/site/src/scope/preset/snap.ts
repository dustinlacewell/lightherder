/*
 * HeroPreset ↔ JSON snapshot. Walks every dial tree in the preset
...
export function presetToSnap(preset: HeroPreset): HeroSnap {
  return {
...
export function presetFromSnap(snap: HeroSnap): HeroPreset {
