/*
 * Generate a `.glsl.gen.ts` module next to each beam `.glsl` source,
 * exporting its contents as a plain string constant. Runs before
 * `tsc` — same rationale as crt's gen-shaders script.
 */
...
const shadersDir = join(root, '..', 'src', 'beam', 'shaders')
